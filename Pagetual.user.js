...
(function() {
    ...
    function initConfig(href) {
        ...
        customUrlsInput.placeholder = "https://hoothin.github.io/UserScripts/Pagetual/pagetualRules.json \nhttps://hoothin.github.io/UserScripts/Pagetual/pagetualRules.json";
    ...
    function initRules(callback) {
        ...
        storage.getItem("rulesData", data => {
            ...
            ruleUrls = [{
                id: 1,
                url: data && data.wedata2github ? 'https://hoothin.github.io/UserScripts/Pagetual/items_all.json' : 'https://hoothin.github.io/UserScripts/Pagetual/pagetualRules.json',
                type: 0,
            }];
            if (data) {
                rulesData = data;
